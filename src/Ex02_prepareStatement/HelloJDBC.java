...
public class HelloJDBC {
	public static void main(String[] args) {
		...
		try {
			...
			//
			// Connection con =
			// DriverManager.getConnection("jdbc:mysql://localhost:3306/statement_jdbc_db",pr);
			...
			deleteDir(new File("Ex02_data\\re_Ex02_statement_img\\"));
			deleteDir(new File("Ex02_data\\re_Ex02_statement_text\\"));
